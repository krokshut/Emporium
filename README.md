...
Currently, **Emporium** adds the following to **Balatro**:

- **Jokers**: 17 new jokers, each with unique abilities and effects.
- **Seals**: 5 brand new seals with unique effects.
- **Consumables**: 5 new wax cards to obtain the seals.
- **Booster Packs**: 4 wax booster packs for the new consumables.
- **Tags**: 1 new tag.
...
1. Download the latest **Emporium** release.
